...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <a href="index.php"><input type="submit" name="" value="Home"/><br>
                        
                        <!--</a><a href="index.php"><input type="submit" name="" value="Go to home page"/></a>-->
                    </div>
                    <div class="col-md-9 register-right">
                        
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Sign In for Hackathon</h3>
                                <form method="POST" action="login_script.php"> 
                                <div class="row register-form">
                                    <div class="col-md-3"></div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Email *" value="" name="username" required/>
                                        </div>
                                        <div class="form-group">
